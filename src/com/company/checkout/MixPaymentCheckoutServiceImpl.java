...
import static com.company.StaticConstants.GIFTCARD_BALANCE_LIST;
...
public class MixPaymentCheckoutServiceImpl implements CheckoutService{
    ...
    private static GiftCardBalance findGiftCardBalance(UUID customerId){
        for(Balance giftCarBalance : StaticConstants.GIFTCARD_BALANCE_LIST){
        ...
        StaticConstants.GIFTCARD_BALANCE_LIST.add(giftCarBalance);
