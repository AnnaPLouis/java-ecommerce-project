...
public class DataGenerator {
   ...
   public static void createCustomer(){
      ...
      Address address1Customer1 = new Address("7272", "Gary Avenue", "Miami Beach", "33141", "FL");
   ...
   public static void createDiscount(){
      ...
      Discount rateBasedDiscount = new RateBasedDiscount(UUID.randomUUID(), "Buy 500 get 15% off", 500.00, 15.00);
